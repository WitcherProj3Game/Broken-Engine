...
void ModuleScripting::CompileScriptTableClass(ScriptInstance* script)
{
	...
	luabridge::getGlobalNamespace(L)
		...
		.addFunction("SetAnimationSpeed", &ScriptingAnimations::SetAnimSpeed)
		.addFunction("SetAnimationBlendTime", &ScriptingAnimations::SetAnimBlendTime)
		.addFunction("SetCurrentAnimationBlendTime", &ScriptingAnimations::SetCurrentAnimBlendTime)
